...
public abstract class TetrisPiece {
    ...
    abstract public boolean locationPreview();
    
    //Check for out of bounds on rotation
    private boolean collisionRightHelper(int toCheck) {
        boolean crashFound = true;
        //thie + 2 seems needed to make sure a crash is found
        if(toCheck + Brick.B_WIDTH -2 < game.getWidth()){
            //System.out.println("toCheck is "+ toCheck);
            //System.out.println("gameWidth: " + game.getWidth());
            crashFound = false;
        }
        return crashFound;
    }
    ...
    private boolean collisionLeftHelper(int toCheck) {
        boolean crashFound = true;
        //thie + 2 seems needed to make sure a crash is found
        if(toCheck - Brick.B_WIDTH -2 > Brick.B_WIDTH){
            System.out.println("toCheck is "+ toCheck);
            System.out.println("Edge: " + Brick.B_WIDTH);
            crashFound = false;
        }
        return crashFound;
    }
    ...
    public void mRight() {
        ...
        //System.out.println("falling "+ l[0][0].getBrickY() + level);
            switch (this.rotationState) {
                case -1:
                    if((Brick3.getBrickX() + 2 + Brick.B_WIDTH < game.getWidth())) {
                        allowMove = true;
                    }
                    break;
                case 0:
                    if((Brick4.getBrickX() + 2 + Brick.B_WIDTH < game.getWidth())) {
                        allowMove = true;
                    }
                    break;
                case 1:
                    if((Brick1.getBrickX() + 2 + Brick.B_WIDTH < game.getWidth())) {
                        allowMove = true;
                    }
                    break;
                case 2:
        ...
        if(this.valid == true) {
            ...
            switch (this.rotationState) {
                case -1:
                    ...
                    break;
                case 0:
                    if((Brick2.getBrickX() - 2 + Brick.B_WIDTH > Brick.B_WIDTH)) {
                        allowMove = true;
                    }
                    break;
                case 1:
                    if((Brick3.getBrickX() - 2 + Brick.B_WIDTH > Brick.B_WIDTH)) {
                        allowMove = true;
                    }
                    break;
                case 2:
                    if((Brick4.getBrickX() - 2 + Brick.B_WIDTH > Brick.B_WIDTH)) {
                        allowMove = true;
                    }
                    break;
            }
